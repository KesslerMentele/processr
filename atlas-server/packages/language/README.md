...
- [src/atlas.langium](src/atlas.langium) -  The grammar definition of your language
- [src/atlas-module.ts](src/atlas-module.ts) - The dependency injection module of your language implementation. Use this to register overridden and added services.
- [src/atlas-validator.ts](src/atlas-validator.ts) - An example validator. You should change it to reflect the semantics of your language.
...
- [src/syntaxes/atlas.monarch.ts](src/syntaxes/atlas.monarch.ts) - Monarch based syntax highlighting instructions.
- [syntaxes/atlas.tmLanguage.json](syntaxes/atlas.tmLanguage.json) - Textmate based syntax highlighting instructions.
